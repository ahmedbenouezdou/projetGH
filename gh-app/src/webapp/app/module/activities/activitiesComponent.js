function activitiesController(moment, calendarConfig, activitiesService,profilService) {
    var ctrl = this;
    ...
    ctrl.addActivities = function addActivities() {
        ...
        activitiesService.addActivite(addActivite,profilService.getProfilId());
    };
...
activitiesController.$injector = ['moment', 'calendarConfig','userService'];

angular.module('activitiesModule').component('activitiescomponent', {
    transclude: true,
    templateUrl: 'app/module/activities/activities.html',
